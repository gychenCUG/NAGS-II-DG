...
def process_sample(ratio_1, ratio_2, ratio_3):
...
class MyProblem(ea.Problem):
    ...
    def __init__(self):
        ...
        Dim = 3  # Initialize the number of decision variables
    ...
    def aimFunc(self, pop):
        ...
        for i in range(len(x1)):
            ...
            r2[i][0],v[i][0],d[i][0] = process_sample(t_x1, t_x2, t_x3)
