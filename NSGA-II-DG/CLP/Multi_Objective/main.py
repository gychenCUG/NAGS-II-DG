...
if __name__ == '__main__':
    ...
    NDSet.save(dirName=f'NDSet/{potName}')  # Save the best individual information to a file
    pop.save(dirName=f'pop/{potName}')
    """==================================Output results=============================="""
    ...
    NDSet_X.columns = ['source1', 'source2', 'source3', 'source4', 'source5', 'source6', 'source7']
    ...
    Y = pd.DataFrame(Y)
    Y.columns = ['r2','v','d']
    X.columns = ['source1', 'source2', 'source3', 'source4', 'source5', 'source6', 'source7']
